...
public class form extends javax.swing.JFrame{
    ...
    public void initComponents(){
        ...
        Label2.setText("La cadena inicia con: ");
    ...
    public void TxtSrtKeyTyped(java.awt.event.KeyEvent event){
        char c =event.getKeyChar();
            if(Character.isDigit(c)){
            getToolkit().beep();
            event.consume();
            JOptionPane.showMessageDialog(null, "Solo puede digitar letras","Error", 1);
            }
    }
